...
/**
 * Una clínica de maternidad necesita un sistema para determinar cuántos bebés
 * han nacido recientemente Dicho sistema solicita al usuario capturar la
 * cantidad de nacimientos (N) el nombre de cada bebé y su sexo (implemente un
 * ciclo do-while para validar la captura siendo M para masculino y F para
 * femenino) Al final, debe imprimir la cantidad de bebés de cada sexo.
 *
 * @author Andres Camilo Gonzalez Velasquez fecha: 04/01/2021 cod: 20201187519
 */
